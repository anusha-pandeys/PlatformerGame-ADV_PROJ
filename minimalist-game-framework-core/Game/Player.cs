...
using System.Runtime.InteropServices;
    ...
    internal class Player : entity {
        ...
        {
            entity.DrawRectangle(new Vector2(100, 100), new Vector2(100, 100), Color.Player);
        }
        ...
        public void Render()
        {
            ...
            // Draw background
            entity.DrawRectangle(new Vector2(0, 0), new Vector2(800, 600), Color.Background);

            // Draw player
            entity.DrawRectangle(playerPosition, new Vector2(PLAYER_WIDTH, PLAYER_HEIGHT), Color.Player);
            ...
            {
                entity.DrawRectangle(new Vector2(i, 500 - BLOCK_SIZE), new Vector2(BLOCK_SIZE, BLOCK_SIZE), Color.Block1);
            }
        }
        ...
        public void DrawRectangle(Vector2 position, Vector2 size, global::Color color)
        {
